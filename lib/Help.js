...
var Help = Class.create( {
    ...
    {
        var titleDiv = $( '<div style="color:#CCCCCC; font:bold; font-size:16px; text-align:center; margin-top:25px;">Carbon dioxide (CO2) and methane (CH4) are the main drivers of climate change, but CH4 is a more powerful greenhouse gas.  </div>' );
