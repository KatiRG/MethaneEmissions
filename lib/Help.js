...
var Help = Class.create( {
    ...
    {
        var titleDiv = $( '<div style="color:#CCCCCC; font:bold; font-size:16px; text-align:center; margin-top:10px;">Carbon dioxide (CO<sub>2</sub>) and methane (CH<sub>4</sub>) are the main drivers of climate change, but CH<sub>4</sub> is a more powerful greenhouse gas. <br>  The latest Intergovernmental Panel on Climate Change report [IPCC, 2013] states that CH<sub>4</sub> concentrations have increased by 150% since the Industrial Era.<br>After almost one decade of stable CH<sub>4</sub> concentrations since the late 1990s, CH<sub>4</sub> concentrations have grown since 2007.<br>Understanding the CH<sub>4</sub> budget (emission source types across different regions) is key to facing climate change.</div>' );
